...
Concetratevi prima sulla parte logica e poi potete dedicarvi alla parte "grafica"
 -->
<?php
	$capitoli = [
...
<html lang="en" dir="ltr">
	...
	<body>
		...
		<main>
			<div class="container">
				<ul class="qea">
					<?php foreach ($faqs as $k => $value) { ?>
						<li class="qea__item">
							<h2 class="qea__domanda">
								<?php  echo $value['domanda'];
									?>
							</h2>
							<div class="qea__risposta">
